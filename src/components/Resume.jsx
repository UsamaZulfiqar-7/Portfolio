...
import resumePdf from "./Usama_Zulfiqar_Resume.pdf";
...
export default function Resume() {
  ...
  return (
    <section
      id="resume"
      ref={ref}
      className="py-24 px-4 sm:px-6 relative overflow-hidden bg-white dark:bg-gray-900/20"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href={resumePdf}
                download="Usama_Zulfiqar_Resume.pdf"
                className="inline-flex items-center gap-2.5 px-6 py-3.5 bg-gradient-to-r from-blue-500 to-violet-600 hover:from-blue-400 hover:to-violet-500 text-slate-900 dark:text-white font-semibold rounded-xl shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 transition-all hover:scale-105 duration-200"
              >
          ...
          >
            <div className="p-4 rounded-xl bg-slate-100 dark:bg-gray-800/20 border border-slate-200/30 dark:border-gray-700/30 flex items-center gap-3">
            ...
            {keyHighlights.map((hl, i) => (
              <div
                key={hl.title}
                className="p-6 rounded-2xl bg-slate-100/60 dark:bg-gray-800/40 border border-slate-200/50 dark:border-gray-700/50 hover:border-slate-300/70 dark:hover:border-slate-300 dark:border-gray-600/70 hover:bg-slate-100/80 dark:hover:bg-slate-100 dark:bg-gray-800/60 transition-all duration-300 group flex items-start gap-4"
              >
                <div className="w-10 h-10 rounded-xl bg-white dark:bg-gray-900 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-200 shadow-md">
                  <Briefcase className="w-5 h-5 text-violet-400" />
                </div>
                <div>
                  <h4 className="text-slate-900 dark:text-white font-bold mb-1.5 group-hover:text-blue-400 transition-colors">
                    {hl.title}
                  </h4>
