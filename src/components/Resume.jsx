...
export default function Resume() {
  ...
  const keyHighlights = [
    { title: "React.js Developer", details: "Intensive training in modern hooks, standard REST APIs, and client-side structures." },
    { title: "Data Analyst Specialist", details: "Certified in Python analytics (Coursera/Google) and Microsoft Power BI pipelines." },
    { title: "Full-Stack Project Work", details: "Practical MySQL database integrations and modular Node.js backend controllers." },
  ];

  return (
    <section id="resume" ref={ref} className="py-24 px-4 sm:px-6 relative overflow-hidden bg-gray-900/20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Left Side: Summary text & download CTA */}
          <div className={`transition-all duration-700 delay-100 ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
            <span className="text-blue-400 font-semibold text-sm tracking-widest uppercase mb-3 block">My Resume</span>
            
            <h2 className="text-4xl font-black text-white mb-6 leading-tight">
              Looking for a <br />
              <span className="bg-gradient-to-r from-blue-400 to-violet-400 bg-clip-text text-transparent">Professional?</span>
            </h2>
            
            <p className="text-gray-400 leading-relaxed mb-8">
              I am open to both Frontend Development and Data Analyst opportunities. With solid computer science fundamentals, full-stack database knowledge, and hands-on coding expertise, I can quickly integrate and deliver value to your engineering team.
            </p>
          ...
          <div className={`space-y-4 transition-all duration-700 delay-200 ${inView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}>
            <div className="p-4 rounded-xl bg-gray-800/20 border border-gray-700/30 flex items-center gap-3">
              ...
              <span className="text-sm font-black uppercase tracking-widest text-white">Qualifications Highlights</span>
            </div>
