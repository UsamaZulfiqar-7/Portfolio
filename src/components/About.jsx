    ...
    <section id="about" ref={ref} className="py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className={`text-center mb-16 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="text-blue-400 font-semibold text-sm tracking-widest uppercase mb-3 block">Get To Know Me</span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`transition-all duration-700 delay-200 ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              Currently pursuing my Bachelor's in Computer Science, I've built expertise in both
              frontend development and data analytics. I'm passionate about AI, modern web technologies,
              and using data to drive impactful decisions.
            </p>
            ...
            <div className="flex flex-wrap gap-2">
              {["AI & Machine Learning", "React.js", "Data Analytics", "Power BI", "Open Source"].map((tag) => (
                <span key={tag}
                  className="px-3 py-1 text-xs bg-blue-500/10 border border-blue-500/20 text-blue-400 rounded-full font-medium">
                  {tag}
                </span>
              ))}
            </div>
          ...
          <div className={`transition-all duration-700 delay-400 ${inView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}>
              ...
              {stats.map(({ value, label }, i) => (
                <div key={label}
                  ...
                  <div className={`text-3xl font-black mb-1 bg-gradient-to-r ${
                    ...
                    i === 1 ? "from-violet-400 to-pink-400" :
                    i === 2 ? "from-orange-400 to-yellow-400" :
            ...
            <div className="space-y-4">
              {[
                { icon: "🎓", title: "BSCS Final Year", desc: "Graduating with strong CS foundations" },
                { icon: "💻", title: "Frontend Expert", desc: "React.js, Tailwind CSS, modern UI/UX" },
                { icon: "📊", title: "Data Analyst", desc: "Python, Power BI, Excel, visualization" },
                { icon: "🤖", title: "AI Enthusiast", desc: "CNN, deep learning, computer vision" },
              ].map(({ icon, title, desc }) => (
                <div key={title}
