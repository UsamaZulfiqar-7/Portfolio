...
export default function Education() {
  ...
  return (
    <section id="education" ref={ref} className="py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className={`text-center mb-20 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="text-blue-400 font-semibold text-sm tracking-widest uppercase mb-3 block">My Credentials</span>
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-4">
            My <span className="bg-gradient-to-r from-blue-400 to-violet-400 bg-clip-text text-transparent">Journey</span>
          </h2>
