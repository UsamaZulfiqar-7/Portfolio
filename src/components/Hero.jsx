  ...
  return (
    ...
    >
      ...
      <FloatingShape
        ...
        style={{ top: "15%", left: "5%", animationDuration: "4s" }}
      />
      <FloatingShape
        className="w-96 h-96 bg-violet-500"
        style={{
          bottom: "10%",
          right: "5%",
      ...
      />
      <FloatingShape
        className="w-48 h-48 bg-cyan-400"
        style={{
          top: "60%",
          left: "15%",
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-center gap-16 py-16">
        ...
        <div
          className={`flex-1 flex justify-center lg:justify-end transition-all duration-1000 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          <div className="relative w-72 h-72 sm:w-96 sm:h-96">
            ...
            />
            <div
              className="absolute inset-6 rounded-full border border-violet-500/20 animate-spin"
              style={{
            ...
            <div className="absolute inset-10 rounded-3xl border border-gray-700/50 flex items-center justify-center shadow-2xl overflow-hidden group">
              ...
              <div className="absolute bottom-3 left-3 right-3 bg-gray-950/80 backdrop-blur-md border border-gray-800/80 p-3.5 rounded-2xl font-mono text-[10px] sm:text-xs leading-normal opacity-90 transition-all duration-300 group-hover:bg-gray-950/90 shadow-lg z-10">
                ...
                <p className="text-violet-400">
                  const <span className="text-blue-300">dev</span> = {"{"};
                </p>
                <p className="pl-3 text-green-400">
                  role:{" "}
                  <span className="text-orange-300">"Frontend Developer & Data Analyst"</span>,
                </p>
                <p className="pl-3 text-green-400">
                  status: <span className="text-orange-300">"Available"</span>
                </p>
