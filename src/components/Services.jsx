      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            ...
            >
              <div
                className={`absolute top-0 right-0 w-32 h-32 rounded-full opacity-[0.03] bg-gradient-to-br ${service.gradient} blur-2xl group-hover:opacity-[0.08] transition-opacity duration-300`}
              />
              <div
              ...
              <div
                className={`absolute left-0 bottom-0 right-0 h-1 bg-gradient-to-r ${service.gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left`}
              />
            </div>
          ))}
        </div>
