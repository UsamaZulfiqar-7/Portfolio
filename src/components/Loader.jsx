    ...
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-gray-950"
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <div className="relative w-24 h-24">
          <div className="absolute inset-0 rounded-2xl border-2 border-blue-500/40 animate-spin"
            style={{ animationDuration: "3s" }} />
          <div className="absolute inset-2 rounded-xl border-2 border-violet-500/40 animate-spin"
        ...
        <p className="text-gray-500 text-xs">{Math.min(Math.round(progress), 100)}%</p>
      </div>
    </div>
  );
}
